...
<style lang="scss">
@import url('https://fonts.googleapis.com/css2?family=Spartan:wght@100;300;500;700&display=swap');
@import url('https://fonts.googleapis.com/css2?family=Antonio:wght@100;400;500;700&display=swap');
:root {
    --color-primary: #070724;
    --text-color-main: #ffffff;
    --text-color-secondary: rgba(255, 255, 255, 0.6);
    --text-fancy: 'Antonio', sans-serif;
    --text-normal: 'Spartan', sans-serif;
    --mercury: #419ebb;
    --venus: #f7cc7f;
    --earth: #545bfe;
    --mars: #ff6a45;
